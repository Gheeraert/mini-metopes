...
def metadata() -> DocumentMetadata:
    return DocumentMetadata(METADATA_SCHEMA_VERSION, SourceDocument("x.docx", "a" * 64), "fr", "Titre", contributors=(Contributor("person-1", "author", given_name="A", family_name="B", affiliation_ids=("affiliation-1",)),), affiliations=(Affiliation("affiliation-1", "Universite"),))
